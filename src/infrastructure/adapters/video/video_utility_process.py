...
class VideoSourceManager:
    ...
    def ensure_video_source(self,
        ...
        desired_source = requested_source if requested_source is not None else self._current_source
        ...
        if desired_source != self._current_source:
            ...
            try:
                ...
                logger.info(f"Trocando Source de {self._current_source} para {desired_source}")
                self._warn_unavailable = False
                self._last_retry = 0.0
