...
from src.domain.services.driving.detour.detour_service import activate_detour_mode
...
from src.domain.services.driving.stop_sign_service import STOP_SIGN_LABEL
