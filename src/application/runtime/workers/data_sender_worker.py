...
from src.application.runtime.services.communication.serial_service import (
    publish_serial_data,
...
def data_sender_process(lane_queue,
    ...
    try:
        while shared_controls.is_running():
            ...
            sync_object_data_from_queue(manual_md=shared_controls.manual_mode,
            ...
            publish_serial_data(obj_data=obj_data,
                                lane_data=lane_data,
                                serial_comm=serial_comm,
                                logger=logger,
