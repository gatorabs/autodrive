...
from src.application.runtime.pipelines.lane_pipeline import (
    compute_distances,
    publish,
...
from src.application.runtime.services.control.pid_controller_service import (
...
def lane_detection_process(lane_queue,
    ...
    pid = create_pid_controller(last_pid_flag, logger)
